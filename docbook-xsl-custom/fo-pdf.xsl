...
<xsl:stylesheet version="1.0"
  ...
  <xsl:import href="handout-titlepage.xsl"/>
  ...
  <xsl:template name="pickfont-sans">
    <xsl:text>Source Sans Pro</xsl:text>
  </xsl:template>

  <xsl:template name="pickfont-serif">
    <xsl:text>Source Serif Pro</xsl:text>
  </xsl:template>

  <xsl:template name="pickfont-mono">
    <xsl:text>Source Code Pro</xsl:text>
  </xsl:template>
